...
<div class="container">
    ...
    <div class="dashboard-grid">
        <div class="dashboard-item">
            ...
            <p>100</p>
            <p><a href="applications.html">List</a></p>
        </div>
        <div class="dashboard-item">
            <i class="fas fa-exclamation-circle fa-3x"></i>
            <h2>Overdue Rent</h2>
            <p>£500</p>
            <p><a href="applications.html">Send Notification</a></p>
        </div>
        <div class="dashboard-item">
            <i class="fas fa-money-bill-wave fa-3x"></i>
            <h2>Upcoming Expenses</h2>
            <p>£1,000</p>
            <p><a href="applications.html">Check Expenses</a></p>
        </div>
        <div class="dashboard-item">
            <i class="fas fa-eye fa-3x"></i>
            <h2>Viewing Applications</h2>
            <p>5</p>
            <p><a href="applications.html">View</a></p>
        </div>
    </div>

    <div class="add-property-container">
        <a href="newproperty.html"><button class="add-property-btn">Add Property</button></a>
    </div>
