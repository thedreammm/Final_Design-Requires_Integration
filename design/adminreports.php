...
<body class="bg-gray-200">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-1/5 bg-white shadow-lg">
            ...
            <nav class="mt-10">
                <a class="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="admindashboard.html">
                    <i class="fas fa-tachometer-alt"></i>
                    <span class="mx-4 font-medium">Dashboard</span>
                </a>
                <a class="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="adminusers.html">
                    <i class="fas fa-users"></i>
                    <span class="mx-4 font-medium">Users</span>
                </a>
                <a class="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="adminproperties.html">
                    <i class="fas fa-home"></i>
                    <span class="mx-4 font-medium">Properties</span>
                </a>
                <a class="flex items-center py-2 px-8 bg-gray-200 text-gray-700 border-r-4 border-gray-700" href="adminreports.html">
                    <i class="fas fa-file-alt"></i>
                    <span class="mx-4 font-medium">Reports</span>
                </a>
                <a class="flex items-center py-2 px-8 text-gray-600 hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="adminsettings.html">
