        ...
        <div class="container mx-auto px-6">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-4 rounded-lg shadow-lg">
                    ...
                    <a href="detail.html" class="inline-block bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">View</a>
                </div>
                <!-- ... other properties ... -->
                <div class="bg-white p-4 rounded-lg shadow-lg">
                    <img class="rounded-lg mb-4" src="https://placehold.co/600x400" alt="Placeholder image of a property">
